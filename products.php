              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="row">
                    <?php
                    $paginationCtrls = '';
                    $count_query = $mysqli->query( "SELECT COUNT(ID) FROM products WHERE (status='published' || status='sale')" );
                    ...
                    $get_products_stmt = $mysqli->prepare( "SELECT * FROM products WHERE (status='published' || status='sale') ORDER BY name ASC $limit" );
