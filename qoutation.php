...
if( isset( $_POST['finalize-cart'] ) ) {
  ...
  if( $payment < $cart_total ){
    ...
    $insert_order = $mysqli->prepare( "INSERT INTO orders (type, sub_amount, amount, products, status, customer_type, user_ID) VALUES (?, ?, ?, ?, ?, ?, ?)" );
    $insert_order->bind_param( 'ssssssi', $type, $cart_sub_total, $cart_total, $products_serialize, $status, $customer_type, $user_id );
...
<body>
  ...
  <div class="site-wrap">
           ...
           <div class="icons">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">                
                <li class="active"><a href="qoutation.php"> Regular</a></li>
                <li><a href="qoutation_member.php"> Member</a></li>                                  
              </ul>
            </nav>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php" class="text-lighted">Admin</a> <span class="mx-2 mb-0">/</span> <a href="#" class="text-lighted">Qoutaion</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Regular</strong></div>
        </div>
      </div>
    </div>
            ...
            <div class="p-4" role="alert">
              ...
              if ($get_cart_items == false){
                ...
                if( count( get_cart_items() ) > 0 ) : ?>
                  <div class="row mb-5">
                    <form class="col-md-12" method="POST" action="qoutation.php">
                      <div>                          
                        <table class="table">
                          <thead>
                            <tr>                                
                            ...
                            foreach( get_cart_items() as $id => $q ) :
                              ...
                              if( $get_product_result->num_rows > 0 ) {
                                ...
                                while( $row = $get_product_result->fetch_assoc() ) : 
                                  ...
                                  <td><a href="qoutation.php?action=delete&id=<?php echo $id; ?>" class="btn btn-primary height-auto btn-sm">X</a></td>
                    ...
                    <form method="POST" action="qoutation_complete.php">                                     
                      <div class="qoutation-summary">
                        ...
                        <div class="form-group row space-top">
                          ...
                          <div class="col-md-4">
                            ...
                            <input type="hidden" class="pos-input" id="total" name="total" value="<?php echo$cart_total;?>">                     
                          </div>
                        </div>
