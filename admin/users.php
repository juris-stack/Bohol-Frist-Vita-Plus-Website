    ...
    <div class="col-md-12">
        ...
        <div class="table-data__tool">
            ...
            <div class="table-data__tool-right">
                <a href="<?php echo site_url( '/admin/user.php?action=add' ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                    ...
                    if( $get_brand_result->num_rows > 0 ) :
                        while( $row = $get_brand_result->fetch_assoc() ) :
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td><a href="profile.php?id=<?php echo $uid; ?>" class="title"><?php echo $row['username']; ?></a></td>
