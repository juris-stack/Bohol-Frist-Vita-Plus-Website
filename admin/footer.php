...
?>
        ...
        <link rel="stylesheet" type="text/css" href="../assets/vendor/chosen/chosen.min.css?ver=<?php echo $verion; ?>">
        <script src="../assets/vendor/chosen/chosen.jquery.min.js?ver=<?php echo $verion; ?>"></script>
