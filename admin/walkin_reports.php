...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            <h2 class="title-1">Walk-in Reports</h2>
        </div>
    </div>
</div>
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=today' ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                            ...
                            <tbody>
                                <?php foreach( $todays as $today ) : ?>
                                    <tr class="tr-shadow">
                                        ...
                                        <!-- <td><?php echo $today['customer_type']; ?></td> -->
                                        <td>&#8369;<?php echo number_format($today['amount'], 2); ?></td>
                                        <td><?php echo $today['date_added']; ?></td>
                                        <td><a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=solo&id=' . $today['ID'] ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
            ...
            <div class="tab-pane fade" id="yesterday" role="tabpanel" aria-labelledby="yesterday-tab">
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=yesterday' ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <?php foreach( $yesterdays as $yesterday ) : ?>
                                    <tr class="tr-shadow">
                                        ...
                                        <!-- <td><?php echo $yesterday['customer_type']; ?></td> -->
                                        <td>&#8369;<?php echo number_format($yesterday['amount'], 2); ?></td>
                                        <td><?php echo $yesterday['date_added']; ?></td>
                                        <td><a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=solo&id=' . $yesterday['ID'] ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                <i class="zmdi zmdi-download"></i></a></td>
                                    </tr>
                                    <tr class="spacer"></tr>
                                <?php 
            ...
            <div class="tab-pane fade" id="week" role="tabpanel" aria-labelledby="week-tab">
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=week' ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
                    <?php if( $week_count > 0 ) : ?>
                            ...
                            <tbody>
                                <?php foreach( $weeks as $week ) : ?>
                                    <tr class="tr-shadow">
                                        ...
                                        <!-- <td><?php echo $week['customer_type']; ?></td> -->
                                        <td>&#8369;<?php echo number_format($week['amount'], 2); ?></td>
                                        <td><?php echo $week['date_added']; ?></td>
                                        <td><a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=solo&id=' . $week['ID'] ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                <i class="zmdi zmdi-download"></i></a></td>
                                    </tr>
                                    <tr class="spacer"></tr>
                                <?php 
            ...
            <div class="tab-pane fade" id="month" role="tabpanel" aria-labelledby="month-tab">
                ...
                <div class="m-t-25">
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=month' ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                <i class="zmdi zmdi-download"></i> Generate Report</a>
                        </div>
                    </div>
                                ...
                                <?php foreach( $months as $month ) : ?>
                                    <tr class="tr-shadow">
                                        ...
                                        <!-- <td>
                                            ...
                                            <?php echo $month['customer_type']; ?></td> -->
                                        <td>&#8369;<?php echo number_format($month['amount'], 2); ?></td>
                                        <td><?php echo $month['date_added']; ?></td>
                                        <td><a target="_blank" href="<?php echo site_url( '/admin/generate_walkin_report.php?type=solo&id=' . $month['ID'] ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                <i class="zmdi zmdi-download"></i></a></td>
                                    </tr>
                                    <tr class="spacer"></tr>
                                <?php 
