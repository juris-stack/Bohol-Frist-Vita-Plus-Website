...
<html lang="en">
    <head>
        ...
        <link href="../assets/css/custom-styles.css?ver=<?php echo filemtime( '../assets/css/custom-styles.css' ); ?>" rel="stylesheet" media="all">
    </head>
                    ...
                    <div class="container-fluid">
                        <div class="header-mobile-inner">
                            <a href="<?php echo site_url(); ?>">
                                <h1 class="logo-title">FIRST VITA PLUS</h1>
                            </a>
