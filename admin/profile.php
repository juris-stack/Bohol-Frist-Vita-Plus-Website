                                ...
                                if( $orders_result->num_rows > 0 ) :
                                    while( $row = $orders_result->fetch_assoc() ) : ?>
                                        <tr class="tr-shadow">
                                            ...
                                            <?php if( esc_int( $row['user_ID'] ) === $user_id && $row['status'] !== 'cancelled' && $row['status'] !== 'claimed' ) : ?>
                                                <td>
                                                ...
                                                <?php else: ?>
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <a target="_blank" href="<?php echo site_url( '/admin/generate_online_report.php?type=solo&id=' . $row['ID'] ); ?>" class="au-btn au-btn-icon au-btn--blue au-btn--small" data-toggle="tooltip" data-placement="top" title="Generate Reciept">
